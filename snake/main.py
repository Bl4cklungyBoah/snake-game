...
class SNAKE:
    def __init__(self):
        ...
        self.body_vert = pygame.image.load('graphics/body_vertical.png').convert_alpha()
        self.body_horz = pygame.image.load('graphics/body_horizontal.png').convert_alpha()
        ...
        for index, block in enumerate(self.body):
            ...
            if index == 0:
                ...
                if prev_block.x == next_block.x:
                    ...
                    screen.blit(self.body_horz, block_rect)
                else:
